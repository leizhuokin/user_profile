package cn.edu.zut.userprofile.app


import cn.edu.zut.userprofile.bean.{TagInfo, TaskInfo, TaskTagRule}
import cn.edu.zut.userprofile.constant.ConstCode
import cn.edu.zut.userprofile.dao.{TagInfoDAO, TaskInfoDAO, TaskTagRuleDAO}
import cn.edu.zut.userprofile.util.MyPropertiesUtil
