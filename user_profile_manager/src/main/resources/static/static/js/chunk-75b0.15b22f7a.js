        ...
        var n = s.exports, r = {
            data: function () {
                return {
                    ...
                    execTypeOptions: [{value: "SQL", label: "SPARP_SQL"}, {value: "JAR", label: "SPARK_JAR"}],
                    taskLevelOptions: [{value: "1", label: "1"}, {value: "2", label: "2"}, {
                        value: "3",
                        label: "3"
                    }, {value: "4", label: "4"}, {value: "5", label: "5"}],
                    formLabelWidth: "140px",
                    uploadPath: "http://userprofile.zut.edu.cn/upload",
                    subTagOptions: []
                }
            }, methods: {
            ...
            mounted: function () {
                ...
                return {
                    ...
                    data: [{
                        ...
                        id: 3,
                        tagName: "一级 3333",
                        children: [{id: 7, tagName: "二级 3-1"}, {id: 8, tagName: "二级 3-2"}]
                    }],
            ...
            return a("div", {staticClass: "app-container"}, [a("el-row", {
                ...
                scopedSlots: e._u([{
                    key: "default", fn: function (t) {
                        ...
                        }, [e._v(" 删除标签   ")]), e._v(" "), o.taskId ? a("el-button", {
                            attrs: {
                                type: "text",
                                size: "mini",
                                ...
                                click: function () {
                                    return e.tagTaskEdit(o)
                                }
                            }
                        }, [e._v("  管理任务 ")]) : a("el-button", {
                            attrs: {
                                type: "text",
                                size: "mini",
                                icon: "el-icon-s-unfold",
