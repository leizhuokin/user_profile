(window.webpackJsonp = window.webpackJsonp || []).push([["app"], {
    "/V+n": function (t, e, n) {
        ...
        i.default.use(a.a);
        var p = new a.a.Store({modules: {app: s, user: d}, getters: h});
        e.a = p
    }, "R/Hx": function (t, e, n) {
        "use strict";
        n.r(e);
        ...
        var d = u.exports, h = n("jE9Z"), p = n("QbLZ"), m = n.n(p), v = n("L2JU"), f = n("vRGJ"), b = n.n(f), g = {
            data: function () {
        ...
        }, k = (n("hVtZ"), Object(l.a)(x, function () {
            var t = this.$createElement, e = this._self._c || t;
            return e("div", [e("svg", {
        ...
        var y = {
            components: {Breadcrumb: _, Hamburger: k.exports},
            computed: m()({}, Object(v.b)(["sidebar", "avatar"])),
            methods: {
        ...
        var H = {
            ...
            methods: {
                hasOneShowingChild: function (t, e) {
                    ...
                    return 1 === i.length || 0 === i.length && (this.onlyOneChild = m()({}, e, {
                        path: "",
                        noShowingChildren: !0
                    }), !0)
        ...
        var N = j.exports, $ = {name: "AppMain", computed: {}}, D = (n("xOwI"), Object(l.a)($, function () {
            var t = this.$createElement, e = this._self._c || t;
        ...
        var F = D.exports, K = n("Q2AE"), P = document.body, U = {
            name: "Layout", components: {Navbar: E, Sidebar: N, AppMain: F}, mixins: [{
                watch: {
                    $route: function (t) {
                        "mobile" === this.device && this.sidebar.opened && K.a.dispatch("CloseSideBar", {withoutAnimation: !1})
                    }
                }, beforeMount: function () {
                    window.addEventListener("resize", this.resizeHandler)
                }, mounted: function () {
                    this.isMobile() && (K.a.dispatch("ToggleDevice", "mobile"), K.a.dispatch("CloseSideBar", {withoutAnimation: !0}))
                }, methods: {
                    isMobile: function () {
                        ...
                        if (!document.hidden) {
                            var t = this.isMobile();
                            K.a.dispatch("ToggleDevice", t ? "mobile" : "desktop"), t && K.a.dispatch("CloseSideBar", {withoutAnimation: !0})
                        }
                    }
                }
            }], computed: {
        ...
        J.beforeEach(function (t, e, n) {
            W.a.start(), Object(tt.a)() ? "/login" === t.path ? (n({path: "/"}), W.a.done()) : 0 === K.a.getters.roles.length ? K.a.dispatch("GetInfo").then(function (t) {
                n()
            }).catch(function (t) {
        ...
        var i = n("4d7F"), a = n.n(i), o = n("vDqi"), r = n.n(o), s = n("XJYT"), c = n("Q2AE"), l = n("X4fA"),
            u = r.a.create({baseURL: "http://userprofile.zut.edu.cn", timeout: 5e5});
